...
class ManpowerController extends CI_Controller
{
  ...
  public function tambah($id)
  {
    if (isset($_POST['submit'])) {
      ...
      $validasi = $this->gaji->validasi_detail($data['detail_tanggal'],'manpower',$data['detail_gaji_id']);
      if ($validasi == null) {
  ...
  public function laporan($dataBulan)
  {
    ...
    $this->load->view('templates/header');
    $this->load->view('gaji/manpower/laporan',$data);
    $this->load->view('templates/footer');
  }
  public function bank($dataBulan)
  {
      ...
      $data['detail'] = $this->gaji->detailSeluruh($dataBulan);
      $this->load->view('templates/header');
      $this->load->view('gaji/manpower/bank',$data);
      $this->load->view('templates/footer');
