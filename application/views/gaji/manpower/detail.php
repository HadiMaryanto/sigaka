...
<div class="col-12">
  <div class="card">
    ...
    <div class="modal fade" id="exampleModal1" tabindex="-1" role="dialog" aria-labelledby="formModal"
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="needs-validation" novalidate="" action="<?php echo base_url('manpower/potongan/'.$id) ?>" method="post">
              <div class="form-group">
    ...
    <!-- <?php foreach ($ubahPotong as $key => $value): ?> -->
      <div class="modal fade" id="exampleModal2<?php echo $ubahPotong['potongan_id'];?>" tabindex="-1" role="dialog" aria-labelledby="formModal"
          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form class="needs-validation" novalidate="" action="<?php echo base_url('manpower/ubahPot/'.$id) ?>" method="post">
                  <div class="form-group">
                    <label>Kesehatan</label>
                    <div class="input-group">
                      <div class="input-group-prepend">
