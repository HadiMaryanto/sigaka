          ...
          <tbody>
            <?php if ($gaji != null): ?>
              ...
              <tr>
                ...
                <td>
                  <a href="<?php echo base_url('contract/detail/').$value['gaji_id'] ?>" class="btn btn-primary btn-sm">Detail</a>
                </td>
              </tr>
              <?php $no++;endif; ?>
              <?php endforeach; ?>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="needs-validation" novalidate="" action="<?php echo base_url('contract/pekerjabaru/'.$this->uri->segment(3)) ?>" method="post">
